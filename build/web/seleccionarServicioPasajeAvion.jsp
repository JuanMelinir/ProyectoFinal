...
<div class="menu">
<lu>
  <li class="elementoMenu"><a hre="seleccionarServicio.jsp"><h5  id="seleccionado">Ver</h5></a></li>
  <li class="elementoMenu"><a href="cargarServicio.jsp"><h5 id="titulosMenu">Cargar</h5></a></li>
</lu>  
</div>
<div class="menuServicios">
<lu>
    <li class="elementoMenu"><a href="seleccionarServicioPaqueteHotel.jsp"><h5 id="titulosMenu">Hoteles</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaqueteAlquiler.jsp"><h5  id="titulosMenu" >Alquiler de vehículos</h5></a></li>
  <li class="elementoMenu"><a href=""><h5 id="seleccionadoSubMenu">Pasajes avión</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaquetePasajeColectivo.jsp"><h5 id="titulosMenu">Pasajes colectivo</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaquetePasajeTren.jsp"><h5 id="titulosMenu">Pasajes tren</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaqueteExcursiones.jsp"><h5  id="titulosMenu">Excursiones</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaqueteEventos.jsp"><h5 id="titulosMenu">Eventos</h5></a></li>
</lu>  
</div>
                    ...
                    <tbody>
                        ...
                        for(Servicio servicio:listaServicios){
                            ...
                            <td class="cell100 column1">
                                <form class="modificar"  action="SvModificarServicio" method="POST" style="display:inline">
                                <input type="hidden" name="id" value="<%=id%>">
