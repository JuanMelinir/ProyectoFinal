      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link " aria-current="page" href="seleccionarPaquete.jspp">Paquetes</a>
            </li>
...
<lu>
  ...
  <li class="elementoMenu"><a href=""><h5  id="seleccionadoSubMenu">Alquiler de vehículos</h5></a></li>
  <li class="elementoMenu"><a href="seleccionarServicioPaquetePasajeAvion.jsp"><h5 id="titulosMenu">Pasajes avión</h5></a></li>
