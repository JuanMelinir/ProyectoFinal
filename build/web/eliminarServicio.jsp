  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light " id="nav">
      <div class="container-fluid">
        ...
        <div class="menu">
        <lu>
            <li class="elementoMenu"><a href="seleccionarServicio.jsp"><h5 id="titulosMenu">Seleccionar</h5></a></li>
          ...
          <li class="elementoMenu"><a href="modificarServicio.jsp"><h5 id="titulosMenu">Modificar</h5></a></li>
        </lu>  
        </div>
    
        <form class="cargar">
          <label for="buscar" id="label">Buscar servicio</label><br> 
          <input type="text" placeholder="Ingrese código de servicio " id="datos" label=""><br>
          <button type="button" class="btn btn-success">Buscar</button>
          <label for="nombre" id="form-check-label">Código servicio</label><br> 
