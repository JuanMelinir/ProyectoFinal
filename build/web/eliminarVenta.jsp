  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.0/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light " id="nav">
      <div class="container-fluid">
        ...
        <section class="eliminarVentas" data-aos="zoom-in-down">
                    <div class="menu">
                    <lu>
                    ...
                    <form class="cargar">
                      <label for="buscar" id="label">Buscar venta</label><br> 
                      <input type="text" placeholder="Ingrese dni cliente " id="datos" label=""><br>
