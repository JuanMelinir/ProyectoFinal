                  ...
                  <li class="elementoMenu"><a href="mostrarVenta.jsp"><h5 id="titulosMenu">Mostrar</h5></a></li>
                      ...
                      <select name="" class="seleccion">
                        <option value="N">Venta 1</option>
                          ...
                          <form class="cargar">
                            <label for="nombre" id="label">Código servicio</label><br> 
                            <input type="text" placeholder="ingrese número de servicio " id="datos" label=""><br>
                            ...
                            <input type="text" placeholder="ingrese descripción del servicio " id="datos" label=""><br>
