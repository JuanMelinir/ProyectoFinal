...
<lu>
  ...
  <lu>
  <li ><a href="seleccionarServicioPaquetePasajeAvion.jsp" ><h5 id="titulosMenu">Pasajes avión</h5></a></li>
  <li ><a href=""><h5 id="seleccionadoSubMenu" class="sublista">Pasajes colectivo</h5></a></li>
  <li ><a href="seleccionarServicioPaquetePasajeTren.jsp" class="sublista"><h5 id="titulosMenu">Pasajes tren</h5></a></li>
  </lu>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        for(Servicio servicio:listaServicios){
                            ...
                            if(nombre.toUpperCase().compareTo("PASAJE COLECTIVO")==0)
                            {%> 
