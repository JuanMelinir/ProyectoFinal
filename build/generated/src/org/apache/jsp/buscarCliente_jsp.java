...
public final class buscarCliente_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            </li>\n");
      out.write("                            <li class=\"nav-item\">\n");
      out.write("                                <a class=\"nav-link \"  aria-current=\"page\" href=\"cargarServicio.jsp\" >Servicios</a>\n");
      out.write("                            </li>\n");
      out.write("                            <li class=\"nav-item\">\n");
      out.write("                                <a class=\"nav-link \" aria-current=\"page\" href=\"cargarPaquete.jsp\">Paquetes</a>\n");
      out.write("                            </li>\n");
      out.write("\n");
      out.write("                            <li class=\"nav-item\">\n");
      ...
      out.write("                <lu>\n");
      out.write("                    <li class=\"elementoMenu\"><a href=\"buscarCliente.jsp\"><h5 id=\"seleccionado\">Buscar</h5></a></li>\n");
      out.write("                    <li class=\"elementoMenu\"><a href=\"cargarCliente.jsp\"><h5  id=\"titulosMenu\">Cargar</h5></a></li>\n");
      out.write("                    <li class=\"elementoMenu\"><a href=\"eliminarCliente.jsp\"><h5 id=\"titulosMenu\">Eliminar</h5></a></li>\n");
      out.write("                    <li class=\"elementoMenu\"><a href=\"\" ><h5 id=\"titulosMenu\">Modificar</h5></a></li>\n");
      out.write("                </lu>  \n");
      out.write("            </div>\n");
      out.write("            <form class=\"cargar\">\n");
      out.write("                <label for=\"buscar\" id=\"label\">Buscar cliente</label><br> \n");
      ...
      out.write("            </form>\n");
      out.write("            <form class=\"cargar\">\n");
      out.write("                <label for=\"nombre\" id=\"label\">Datos del cliente</label><br> \n");
      out.write("                <label for=\"nombre\" id=\"label\">Id Cliente</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"Ingrese número id \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Nombre</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese nombre \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Apellido</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese apellido \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Dirección</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese dirección \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">DNI</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese número de DNI \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Fecha de nacimiento</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese fecha de nacimiento \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Nacionalidad</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese nacionalidad \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Celular</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese número de celular \" id=\"datos\" label=\"\"><br>\n");
      out.write("                <label for=\"nombre\" id=\"label\">Email</label><br> \n");
      out.write("                <input type=\"text\" placeholder=\"ingrese correo electrónico\" id=\"datos\" label=\"\"><br>\n");
      out.write("                <button type=\"button\" class=\"btn btn-success\">Cargar</button>\n");
      out.write("            </form>\n");
      out.write("        </section>\n");
