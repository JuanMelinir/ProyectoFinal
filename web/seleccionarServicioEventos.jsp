...
<lu>
  ...
  <li class="elementoMenu"><a href="seleccionarServicioExcursiones.jsp"><h5 id="titulosMenu">Excursiones</h5></a></li>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        for(Servicio servicio:listaServicios){
                            ...
                            <td class="cell100 column1">
                                <form class="modificar"  action="SvSeleccionarServicio" method="POST" style="display:inline">
                                <input type="hidden" name="id" value="<%=id%>">
