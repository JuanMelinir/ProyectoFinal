...
<header>
    ...
    <form class="cargar" action="SvEmpleado" method="post">
        <label for="nombre" id="label">Datos a ingresar</label><br> 
            ...
            <input type="text" placeholder="ingrese cargo" id="datos" label="" name="cargo"><br>
            <label for="nombre" id="label">Sueldo</label><br> 
            <input type="text" placeholder="ingrese sueldo" id="datos" label="" name="sueldo"><br>
            <label for="nombre" id="label">Usuario</label><br> 
            <input type="email"placeholder="ingrese usuario" id="datos" label="" name="usuario"><br>
            <label for="nombre" id="label">Contraseña</label><br> 
            <input type="text" placeholder="ingrese contraseña" id="datos" label="" name="contra"><br>
