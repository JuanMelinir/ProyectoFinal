...
<lu>
  ...
  <li class="elementoMenu"><a href=""><h5  id="titulosMenu">Alquiler de vehículos</h5></a></li>
  ...
  <li class="elementoMenu"><a href=""><h5 id="seleccionadoSubMenu">Pasajes tren</h5></a></li>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        for(Servicio servicio:listaServicios){
                            ...
                            if(nombre.toUpperCase().compareTo("Pasaje tren")==0)
                            {%> 
